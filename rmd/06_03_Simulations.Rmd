...
- the average of the best _n_ years across the selected time period.

In the latter case, the ‘best years’ are defined as those with the highest catches, within the selected period, for a given fleet and species over _n_ years.
