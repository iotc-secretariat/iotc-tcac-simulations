...
kable(CB_ALLOCATION_TACS_ALL_YEARS_TABLE_FORMATTED, format.args = list(big.mark = ","))
```
...
kable(ALLOCATION_QUOTAS_ALL_YEARS_TABLE_FORMATTED, format.args = list(big.mark = ","))
```
\newpage
...
kable(ALLOCATION_TACS_ALL_YEARS_TABLE_FORMATTED, format.args = list(big.mark = ","))
```
