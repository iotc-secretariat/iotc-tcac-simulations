...
```{r DevelopingStateAllocationEqualTable, ft.align = "center"}
kable(DS_EQUAL_ALLOCATION_TABLE_FORMATTED, align = c("l", "l", "l", "c", "r", "r"), format.args = list(big.mark = ","))
```
...
```{r DevelopingStateAllocationLdcTable, ft.align = "center"}
kable(DS_LDC_ALLOCATION_TABLE_FORMATTED, align = c("l", "l", "l", "c", "r", "r"), format.args = list(big.mark = ","))
```
...
```{r DevelopingStateAllocationSidsTable, ft.align = "center"}
kable(DS_SIDS_ALLOCATION_TABLE_FORMATTED, align = c("l", "l", "l", "c", "r", "r"), format.args = list(big.mark = ","))
```
