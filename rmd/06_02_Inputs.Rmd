...
Historical catch data for albacore, bigeye tuna, skipjack tuna, swordfish and yellowfin tuna are available for the period 1950–2024. These data are provided in [IOTC-2026-TCAC16-DATASET02](https://www.iotc.org/TCAC/16/Data/02). A detailed description of the fields included in the file is provided in [Appendix 2](#catchFields).

Catch data are stratified by year, entity, gear, school type, species, and assigned area (see Section [National Jurisdiction Areas & High Seas](#NJAs)) to support allocation analyses. The methodology used to assign catches to areas of operation was presented to the Technical Committee on Allocation Criteria at its twelfth session in October 2023 and endorsed by participants ([IOTC-2023-TCAC12-INF02](https://www.iotc.org/documents/TCAC/12/INF02)). For longline and surface fisheries operating on the high seas, catches were allocated to NJAs based on the proportion of spatial overlap between each regular grid cell and the corresponding NJA (see [IOTC–2017–SC20–INF05](https://www.iotc.org/documents/estimation-eez-catches-iotc-database)). Work is ongoing to incorporate information on licensing agreements in the catch allocation procedure.
