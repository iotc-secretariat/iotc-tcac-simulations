---
title: "Simulation Tool for Allocation Criteria: Data, Interface, and Output"
...
sec_pr = prop_section(
  header_first = bl_header_with_logo("IOTC-2025-TCAC15-INF01", "right"),
  header_default = bl_header_no_logo("IOTC-2025-TCAC15-INF01", "right")
)
```
...
```{r child = "06_02_Configuration.Rmd"}
```

```{r child = "06_03_Simulations.Rmd"}
```

```{r child = "06_04_User_Interface.Rmd"}
```

```{r child = "06_05_Simulation_Results.Rmd"}
```
