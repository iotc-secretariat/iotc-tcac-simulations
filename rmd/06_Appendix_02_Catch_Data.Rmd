...
<!-- -   ENTITY_CODE: Code for [fishing fleets](https://data.iotc.org/reference/latest/domain/admin/#fleets) -->
<!-- -   FISHERY_TYPE_CODE: code for main fishery categories (ART = Artisanal, IND = Industrial) -->
<!-- -   GEAR_CODE: Code for [fishing gears](https://data.iotc.org/reference/latest/domain/fisheries/#Gears)  -->
