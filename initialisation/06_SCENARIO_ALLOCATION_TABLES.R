...
CS_EQUAL_ALLOCATION_TABLE = base::merge(CS_ALLOCATION[, .(CPC_CODE, CSA_EQUAL_ALLOCATION)], CPC_data[STATUS_CODE %in% c("CP", "FE"), .(CODE, STATUS_CODE, NAME_EN, NAME_FR)], by.x = "CPC_CODE", by.y = "CODE", all.y = TRUE)
...
if(!is.null(REPORTING_ENTITY)) CS_EQUAL_ALLOCATION_TABLE_FORMATTED = CS_EQUAL_ALLOCATION_TABLE_FORMATTED[CS_EQUAL_ALLOCATION_TABLE_FORMATTED$Code == REPORTING_ENTITY,]


## SOCIO_ECONOMIC ALLOCATION TABLES ####

### HUMAN DEVELOPMENT INDEX STATUS ALLOCATION TABLE ####
CS_SE_HDI_ALLOCATION_TABLE = base::merge(CS_ALLOCATION[, .(CPC_CODE, CSA_HDI_ALLOCATION)], CPC_data[STATUS_CODE %in% c("CP", "FE"), .(CODE, STATUS_CODE, NAME_EN, NAME_FR)], by.x = "CPC_CODE", by.y = "CODE", all.y = TRUE)

CS_SE_HDI_ALLOCATION_TABLE = base::merge(CS_SE_HDI_ALLOCATION_TABLE, CS_SE_data[, .(CODE, HDI_TIER)], by.x = "CPC_CODE", by.y = "CODE", all.x = TRUE)
...
if(!is.null(REPORTING_ENTITY)) CS_SE_HDI_ALLOCATION_TABLE_FORMATTED = CS_SE_HDI_ALLOCATION_TABLE_FORMATTED[CS_SE_HDI_ALLOCATION_TABLE_FORMATTED$Code == REPORTING_ENTITY,]


### GROSS NATIONAL INCOME STATUS ALLOCATION TABLE #####
CS_SE_GNI_ALLOCATION_TABLE = base::merge(CS_ALLOCATION[, .(CPC_CODE, CSA_GNI_ALLOCATION)], CPC_data[STATUS_CODE %in% c("CP", "FE"), .(CODE, STATUS_CODE, NAME_EN, NAME_FR)], by.x = "CPC_CODE", by.y = "CODE", all.y = TRUE)

CS_SE_GNI_ALLOCATION_TABLE = base::merge(CS_SE_GNI_ALLOCATION_TABLE, CS_SE_data[, .(CODE, GNI_STATUS)], by.x = "CPC_CODE", by.y = "CODE", all.x = TRUE)
...
if(!is.null(REPORTING_ENTITY)) CS_SE_GNI_ALLOCATION_TABLE_FORMATTED = CS_SE_GNI_ALLOCATION_TABLE_FORMATTED[CS_SE_GNI_ALLOCATION_TABLE_FORMATTED$Code == REPORTING_ENTITY,]


### SMALL ISLANDS DEVELOPING STATUS ALLOCATION TABLE #####
CS_SE_SIDS_ALLOCATION_TABLE = base::merge(CS_ALLOCATION[, .(CPC_CODE, CSA_SIDS_ALLOCATION)], CPC_data[STATUS_CODE %in% c("CP", "FE"), .(CODE, STATUS_CODE, NAME_EN, NAME_FR)], by.x = "CPC_CODE", by.y = "CODE", all.y = TRUE)
...
if(!is.null(REPORTING_ENTITY)) CS_SE_SIDS_ALLOCATION_TABLE_FORMATTED = CS_SE_SIDS_ALLOCATION_TABLE_FORMATTED[CS_SE_SIDS_ALLOCATION_TABLE_FORMATTED$Code == REPORTING_ENTITY,]


## NATIONAL JURISDICTION AREA ALLOCATION TABLE ####
CS_NJA_ALLOCATION_TABLE = base::merge(CS_ALLOCATION[, .(CPC_CODE, CSA_NJA_ALLOCATION)], CPC_data[STATUS_CODE %in% c("CP", "FE"), .(CODE, STATUS_CODE, NAME_EN, NAME_FR, NJA_SIZE)], by.x = "CPC_CODE", by.y = "CODE", all.y = TRUE)
...
if(!is.null(REPORTING_ENTITY)) CS_NJA_ALLOCATION_TABLE_FORMATTED = CS_NJA_ALLOCATION_TABLE_FORMATTED[CS_NJA_ALLOCATION_TABLE_FORMATTED$Code == REPORTING_ENTITY,]
...
CS_ALLOCATION_TABLE = base::merge(CS_ALLOCATION[, .(CPC_CODE, COASTAL_STATE_ALLOCATION)], CPC_data[STATUS_CODE %in% c("CP", "FE"), .(CODE, STATUS_CODE, NAME_EN, NAME_FR)], by.x = "CPC_CODE", by.y = "CODE", all.y = TRUE)
