...
if(!is.null(REPORTING_ENTITY)){
 DS_ALLOCATION = DS_ALLOCATION[DS_ALLOCATION$ENTITY_CODE == REPORTING_ENTITY,] 
 # CS_ALLOCATION = CS_ALLOCATION[CS_ALLOCATION$ENTITY_CODE == REPORTING_ENTITY,] 
 CB_ALLOCATION = CB_ALLOCATION[CB_ALLOCATION$ENTITY_CODE == REPORTING_ENTITY,]
 QUOTAS = QUOTAS[QUOTAS$ENTITY_CODE == REPORTING_ENTITY,]
}
